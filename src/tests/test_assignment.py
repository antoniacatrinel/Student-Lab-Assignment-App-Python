...
from src.validation.validators import ValidatorAssignment
...
class TestAssignmentRepository(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._text_file_repo = AssignmentTextFileRepository('test_files/assignments_test.txt')
        self._bin_file_repo = AssignmentBinFileRepository('test_files/assignments_test.pickle')
    ...
    def test_text_search_assignment__by_id(self):
        open('test_files/assignments_test.txt', 'w').close()
        assign_id = 99
        desc = 'problem 2'
        deadline = datetime.date(2010, 12, 14)
        deadline = deadline.strftime('%d/%m/%Y')
    ...
    def test_bin_search_assignment__by_id(self):
        open('test_files/assignments_test.pickle', 'w').close()
        assign_id = 99
        desc = 'problem 2'
        deadline = datetime.date(2010, 12, 14)
        deadline = deadline.strftime('%d/%m/%Y')
    ...
    def test_bin_remove_repo_assignment_by_id(self):
        ...
        self.assertEqual(len(self._bin_file_repo.get_all_assignments()), 2)
