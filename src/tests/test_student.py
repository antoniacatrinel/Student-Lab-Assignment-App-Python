...
from src.validation.validators import ValidatorStudent
...
class TestStudentRepository(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._text_file_Repo = StudentTextFileRepository('test_files/students_test.txt')
        self._bin_file_Repo = StudentBinFileRepository('test_files/students_test.pickle')
    ...
    def test_text_search_student_by_id(self):
        open('test_files/students_test.txt', 'w').close()
        stud_id = 24
        name = 'Gigel'
        group = 912
        student = Student(stud_id, name, group)
    ...
    def test_bin_search_student_by_id(self):
        open('test_files/students_test.pickle', 'w').close()
        stud_id = 24
        name = 'Gigel'
        group = 912
        student = Student(stud_id, name, group)
    ...
    def test_bin_remove_repo_student_by_id(self):
        ...
        student = Student(stud_id, name, group)
        self._bin_file_Repo.add_student(student)
        self.assertEqual(len(self._bin_file_Repo.get_all_students()), 2)
