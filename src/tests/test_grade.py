...
from validation.validators import ValidatorGrade, ValidatorInput, ValidatorStudent
from exceptions.exceptions import RepositoryError, ValidationError, InputError
...
class TestGradeRepository(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._text_file_repo = GradeTextFileRepository('grades_test.txt')
        self._bin_file_repo = GradeBinFileRepository('grades_test.pickle')
    ...
    def test_text_repo_search_by_student_id(self):
        ...
        self.assertEqual(str(re.exception), "Nonexistent student id!\n")
        open('grades_test.txt', 'w').close()
    
    def test_bin_repo_search_by_student_id(self):
        open('grades_test.pickle', 'w').close()
        grade = Grade(78, 24, 4)
...
class TestGradeService(unittest.TestCase):
    ...
    def test_create_list_of_late_students(self):
        ...
        self.assertEqual(int(list_late[0]['ungraded']), 1)
